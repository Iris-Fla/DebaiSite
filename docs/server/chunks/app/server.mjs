import { version, toRef, useSSRContext, hasInjectionContext, getCurrentInstance, inject, ref, watchEffect, watch, defineComponent, createApp, reactive, unref, h, Suspense, nextTick, Transition, computed, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-ae252220.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4b0cba14.mjs').then((m) => m.default || m)
  },
  {
    name: "main",
    path: "/main",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/main-e1fa6d30.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Kiwi+Maru&amp;display=swap" rel="stylesheet">`);
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-8afed8e9.mjs').then((r) => r.default || r));
...
export { useError as a, useRouter as b, createError as c, entry$1 as default, navigateTo as n, useHead as u };
